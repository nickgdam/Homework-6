...
// Function displays the city entered by the user into the dom
...
// Function pulls city list array from local storage
...
// Funtion saves last searched city to be presented upon reload
...
// Dunction saves citys as an array to local storage
function storeCityArray() {
    localStorage.setItem("cities", JSON.stringify(cityList));
    }

// Adds current city to array in local storage
...
// Function runs the AJAX call and displays the current city, weather, and 5 day forecast to the DOM
async function displayWeather() {
    ...
    var response = await $.ajax({
        ...
        // Gets UV Index and sets color based severity
...
// Function runs AJAX call and appends response to dom
...
// Function passes the city in the history list 
