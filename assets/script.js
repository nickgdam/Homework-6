...
// Pulls the city array from local storage
...
// Saves the current city to local storage array
...
// Runs the AJAX call and displays the current city, weather, and 5 day forecast to the DOM
async function displayWeather() {
    ...
    var response = await $.ajax({
        ...
        // Gettins UV Index info and setting class based on severity
...
// Runs the AJAX call for the 5 day forecast and appends them to the DOM
...
// Passes the city in the history list to the displayWeather function
